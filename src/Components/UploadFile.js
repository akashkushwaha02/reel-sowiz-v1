...
function UploadFile(props) {
    ...
    //         setError("Pleases tell category of video");
    //         setTimeout(()=>{
    //             setError('')
    //         },2000)
    //         return;
    //     }
    //     console.log('fuel', file)
    ...
    const handleChange = async(file) => {
        ...
        console.log('fuel',file, category)
        ...
        <div style={{marginTop:'5rem',marginBottom:'1rem'}}>
            {
                ...
                <>
                   <TextField id="outlined-basic" label="Category" variant="outlined" fullWidth={true} margin="dense" size="small" value={category} onChange={(e)=>setCategory(e.target.value)}/>
